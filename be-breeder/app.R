...
library(pacman)
  ...
  p_load(corrr)
  p_load(tableHTML)
  source("Functions/NCII.R")
  source("Functions/diallels.R")
  source("Functions/gardner.R")
...
# 'Luiz de Queiroz' College of Agriculture, University of Sao Paulo, Brazil."
                fluidRow(
                br(),
                pre(includeText("Info/BeBreederAbout.txt")))
)),
...
# #####################################################################################################################################################################################
      ...
      output$contents11 <- renderPrint({
        if(input$info.11!=TRUE)
          ...
          includeScript("Info/BeBreederDataFileInformation.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contents12 <- renderPrint({
        if(input$info.12!=TRUE)
          ...
          includeScript("Info/BeBreederEstatisticalInformation.txt")})
...
# ##############################################################################################################################################################################
      ...
      output$contents1311 <- renderPrint({
        if(input$info.1311!=TRUE)
          ...
          includeScript("Info/BeBreederDiallel.txt")})
      out.1321.0 <- reactive({
...
# ##############################################################################################################################################################################
      ...
      output$contents14.1<- renderPrint({
        if(input$info.141!=TRUE)
          ...
          includeScript("Info/BeBreederDataIndexFile.txt")})
      out.14.1<-reactive({
        if(is.null(out.14()))
          return(NULL)
        IndSel<-out.14()
      ...
      output$contents14.2<- renderPrint({
        if(input$info.142!=TRUE)
          ...
          includeScript("Info/BeBreederDataIndexAnalyse.txt")})
...
# ##############################################################################################################################################################################
      ...
      output$contents151 <- renderPrint({
        if(input$info.151!=TRUE)
          ...
          includeScript("Info/BeBreederDataCorrelation.txt")})
      out.15.1<-reactive({
        if(is.null(out.15.0())){
          return(NULL)}
...
# ##############################################################################################################################################################################
      ...
      output$contents161 <- renderPrint({
        if(input$info.161!=TRUE)
          ...
          includeScript("Info/BeBreederDataPathAnalyse.txt")})
      out.16.1<-reactive({
        if(is.null(out.16.0()))
          return(NULL)
...
# ##############################################################################################################################################################################
      ...
      output$contents171 <- renderPrint({
        if(input$info.171!=TRUE)
          ...
          includeScript("Info/BeBreederbiplot.txt")})
     out.17.1<-reactive({
      if(is.null(out.17.0()))
        return(NULL)
...
# #####################################################################################################################################################################################
      ...
      output$contents18<-renderPrint({
        if(input$info.18!=TRUE)
          ...
          includeScript("Info/BeBreederDataDesing.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol121 <- renderPrint({
        if(input$info.mol121!=TRUE)
          ...
          includeScript("Info/BeBreederMol12.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol241 <- renderPrint({
        if(input$info.mol241!=TRUE)
          ...
          includeScript("Info/BeBreederMol24.txt")})   
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol11 <- renderPrint({
        if(input$info.mol11!=TRUE)
          ...
          includeScript("Info/BeBreederMol13.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol21 <- renderPrint({
        if(input$info.mol21!=TRUE)
          ...
          includeScript("Info/BeBreederMol21.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol31 <- renderPrint({
        if(input$info.mol31!=TRUE)
          ...
          includeScript("Info/BeBreederMol3.txt")})
...
# #####################################################################################################################################################################################
      ...
      output$contentsmol41 <- renderPrint({
        if(input$info.mol41!=TRUE)
          ...
          includeScript("Info/BeBreederMol4.txt")})
...
# #####################################################################################################################################################################################      
      ...
      output$contentsmol51 <- renderPrint({
        if(input$info.mol51!=TRUE){
          ...
          includeScript("Info/BeBreederMol5.txt")})
...
# #####################################################################################################################################################################################      
      ...
      output$contentsmol61 <- renderPrint({
        if(input$info.mol61!=TRUE)
          ...
          includeScript("Info/BeBreederMol6.txt")})
